...
import { Search, ArrowRight, Filter, Grid3x3, List, Flame, CheckCircle, TrendingUp, Users, Award, Bell, Plus } from 'lucide-react';
    ...
    <div className='bg-gray-200 w-[70%] flex flex-col gap-12'>
        ...
        <div className='bg-white/80 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-50'>
            <div className='p-6 flex justify-between items-center'>
                <div>
                    <h1 className='font-black text-4xl bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-1'>
                        Pages
                    </h1>
                    <p className='text-gray-600 font-medium'>Connect • Discover • Grow</p>
                </div>
                <div className='flex gap-3 items-center'>
                    <div className="relative group">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                type="text" 
                                placeholder="Search amazing pages..." 
                                className="pl-12 pr-6 py-4 border-0 rounded-2xl focus:ring-2 focus:ring-purple-500/50 outline-none transition-all duration-300 w-80 bg-white/90 backdrop-blur-sm  placeholder-gray-400 font-medium" 
                            />
                        </div>
                    </div>
                    
                    <div className='relative group mx-5'>
                        <div className='p-3 bg-gradient-to-br from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 rounded-2xl transition-all duration-300 cursor-pointer group-hover:scale-110'>
                            <Bell className='w-5 h-5 text-gray-700' />
                        </div>
                        <div className='absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-r from-red-500 to-pink-500 rounded-full animate-pulse border-2 border-white'></div>
                    </div>
                    
                    <button className="relative group overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105">
