        ...
        <div className='flex flex-col'>
            <div className='flex gap-2 items-center justify-between p-5'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    {/* <p className='text-gray-400 text-[12px]'>&bull; &bull; &bull;</p> */}
                    <Image src='/save.png' width={25} height={20} alt='save' />

                </div>
            </div>
            <p className='font-semibold p-5'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolor consectetur eum molestias vero facilis dignissimos incidunt, fuga ad unde laborum quaerat autem rerum vitae odit consequuntur asperiores, ipsa, veniam nesciunt!</p>
            ...
            <div className="flex gap-1 text-gray-500 hover:cursor-pointer" onClick={() => setLike(!like)}>
                <svg 
                    width="35" 
                    height="20" 
                    viewBox="0 0 24 24" 
                    className={`transform rotate-[-90deg] ${like ? 'text-green-500' : ''}`}
                >
                    <path 
                    fill="currentColor" 
            ...
            <div className="flex gap-1 text-gray-500 hover:cursor-pointer" onClick={() => setDislike(!like)}>
                <svg 
                    width="35" 
                    height="20" 
                    viewBox="0 0 24 24" 
                    className={`transform rotate-[90deg] ${dislike ? 'text-red-500' : ''}`}
                >
                    <path 
                    fill="currentColor" 
                    d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z" 
